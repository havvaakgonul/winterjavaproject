 ...
 * */
	...
	public static void printEvenInt2() {
		for (int i=100;  i>22; i--) {
			...
			// cift sayýlarý vermesi icin sart koyduk
			if(i%2==0) {
				System.out.print(i + " ");
			}
		}
	...
	/*
	 * Print all even integers witch are divisible by 5 from 100 to 23 on the console in the same line with a space among them
*/
