...
public class Arrays01 {
	...
	public static void main(String[] args) {
		...
		// dizinin elaman sayýsý degistiginde otomatik kendini günceliyorsa diynamic 
		// int revNum[]=new int [num.length]; bu metod otomatik dizinin sayýsýný güncelliyor
	...
	//NOTE: If you use 	binarySearch() method without  sorting elements,
		...
		System.out.println(Arrays.binarySearch(num2, 13)); 
