...
public class IfElseStatement06 {
	/*
	 * Ask user to enter annual salary, if the salary is more than  $80.000 output will be “I accept the offer”, if the salary is between
...
otherwise output will be “I do not accept the offer.”
	...
	public static void main(String[] args) {
		...
		System.out.println("Enter the ofter...");
