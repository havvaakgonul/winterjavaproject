...
public class Date01 {
	...
	// in java there is date class
		...
		LocalDate date2=LocalDate.of(2019, 03, 07);
		...
		System.out.println(currentTime1);//21:05:33.006262200
		...
		System.out.println(currentTime2.getNano()-currentTime1.getNano());
		*/
		...
		System.out.println(currentTime1.now(ZoneId.of("Japan")));// 04:19:14.632115700
		System.out.println(currentTime1.now(ZoneId.of("Turkey")));// 22:19:14.642109
		System.out.println(currentTime1.now(ZoneId.of("Europe/Moscow")));	// 22:19:14.646106100	
	
	
		//How to create an object from LocalDateTime
		LocalDateTime dateTime1=LocalDateTime.now();
		System.out.println(dateTime1);//2021-03-07T21:21:44.898254700
	...
	System.out.println(dtf2.format(currentDate2.plusMonths(9)));//21/Ara/07
	
	LocalTime currentTime2=LocalTime.now();
	DateTimeFormatter dtf3=DateTimeFormatter.ofPattern("hh:mm");// is for am-pm time format
																//HH==> is for 24 hours system
	System.out.println(dtf3.format(currentTime2));//09:41
	...
	System.out.println(age);	//	P23Y9M12D
