...
public class AccessModifier02 {
	...
	/*
	 ...
	 b)You can use object of the class ==> Use that way "non-static class members"
	 ...
	 NOTE:Ask that one in the Interwievs
	 ýf a class memeber has "default " access modifier, then you cannot access to it from another packages 
	...
	public static void main(String[] args) {
		...
		System.out.println(obj.shoolName);
