...
public class Lists01 {
	...
	public static void main(String[] args) {
		...
		System.out.println(list1.get(4)); //There is index 4, because of that you will get Run Time Error 
	*/	
		list2.add(9);
		list2.add(2);
		list2.add(19);
		...
		// System.out.println(list2.remove(6)); // no index  you will  get exeption
		...
		// How to remove an element from a list by using the element value
		 ...
		 // Because when you put an integer inside the remove() method it will accept it is index.
