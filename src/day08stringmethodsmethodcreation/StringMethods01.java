...
public class StringMethods01 {
	...
	public static void main(String[] args) {
		...
		// 20) concat() method is used to joýn Strings.
		// "+" and "concat()" does the same. But I recommed to use "concat" instead of "+"
		System.out.println(firstname.concat(" ").concat(lastname));
	
		//3.Way
		System.out.println(str.trim().replaceAll("\\d", "").replace("can?!@", "CAN"));
