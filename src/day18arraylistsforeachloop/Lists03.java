...
public class Lists03 {
		...
		//clear() method removes all of the elements from this
		...
		// containsAll(list2) method returns true if all elements od list2 exist in the list1
		System.out.println(list1.containsAll(list2));
		
		//How to get the index of last occurence (olusum) of an element in a list
		...
		//When you create list by using array, some array features transferred to the list
		...
		// System.out.println(list3); // [[I@19e1023e]  hash code
		
		// list3.remove(2); // UnsupportedOperationExeption
		// list3.clear; // UnsupportedOperationExeption
		//list3.add(34,arr); //UnsupportedOperationExeption
		list3.set(1, 63);
